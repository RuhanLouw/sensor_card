...
#define RUN_LED_TOGGLE()  IO_PD6_Toggle();
    
#define MEASURE_LED_SET() IO_PD4_SetHigh()
#define MEASURE_LED_nSET() IO_PD4_SetLow()
#define MEASURE_LED_TOGGLE()  IO_PD4_Toggle();
...
#define RX1_LED_Toggle() IO_PD2_Toggle()
    
#define RS_TX1() IO_PC3_SetHigh()
#define RS_RX1() IO_PC3_SetLow()
